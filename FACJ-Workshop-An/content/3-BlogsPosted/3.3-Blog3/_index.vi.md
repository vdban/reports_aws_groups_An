...
- Kiến trúc Monitoring của Amazon EMR.
- CloudWatch Logs hiển thị Spark Driver và Executor Logs.
- AWS Console hiển thị YARN ResourceManager UI.
- Mapping giữa EMR Step và YARN Application ID.
